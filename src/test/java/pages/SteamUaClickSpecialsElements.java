...
public class SteamUaClickSpecialsElements extends AbstractBasePage {
    ...
    private final static String BUTTON_SETINGS_ON_SPECIAL_PAGE = "//div[@class='settings_tab']";
    ...
    public WebElement getButtonSetingsOnSpecialPage() {
        return waitUntilElementToBeClickable(BUTTON_SETINGS_ON_SPECIAL_PAGE);
    }
}
