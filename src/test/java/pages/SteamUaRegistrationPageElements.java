...
public class SteamUaRegistrationPageElements extends AbstractBasePage {
    ...
    public WebElement getClickOnContinueButton() {  return waitUntilElementToBeClickable(CONTINUE_BUTTON);}

    public WebElement getErrorDisplay() {  return waitUntilVisibilityOfElementLocated(ERROR_DISPLAY);}
